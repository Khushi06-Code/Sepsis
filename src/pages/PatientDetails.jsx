    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6 bg-gray-50 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1">Age: {patient.age} | Gender: {patient.gender} | ID: {patient.id}</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-red-200 flex flex-col items-center justify-center text-center">
          ...
          <div className="text-7xl font-extrabold text-red-600 mb-2">{patient.prediction}<span className="text-3xl">%</span></div>
          <span className="bg-red-100 text-red-800 text-sm font-medium px-4 py-1.5 rounded-full mt-2">
            {patient.riskLevel || "Pending"}
          </span>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-5 bg-red-50 rounded-xl border border-red-100">
              ...
              <p className="text-3xl font-bold text-red-600">
                {vitals.heartRate} <span className="text-base font-normal text-gray-500">bpm</span>
              </p>
            </div>
            <div className="p-5 bg-red-50 rounded-xl border border-red-100">
              <p className="text-sm text-gray-600 font-medium flex items-center mb-2">
              ...
              <p className="text-3xl font-bold text-red-600">
                {vitals.bloodPressure} <span className="text-base font-normal text-gray-500">mmHg</span>
              </p>
            </div>
            <div className="p-5 bg-red-50 rounded-xl border border-gray-100">
              <p className="text-sm text-gray-600 font-medium flex items-center mb-2">
                <Thermometer className="w-4 h-4 mr-2 text-orange-500" /> Temperature
              </p>
              <p className="text-3xl font-bold text-orange-500">
                {vitals.temperature} <span className="text-base font-normal text-gray-500">°C</span>
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center p-3 bg-red-50 rounded-lg border border-red-100">
              ...
              <div className="text-right">
                <span className="text-xl font-bold text-red-600">{vitals.wbc}</span>
            ...
            <div className="flex justify-between items-center p-3 bg-red-50 rounded-lg border border-red-100">
              ...
              <div className="text-right">
                <span className="text-xl font-bold text-red-600">{vitals.oxygen}</span>
